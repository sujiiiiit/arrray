              ...
              <div className="group relative z-[1] flex w-full items-center">
                <div className="w-full">
                  <div
                    ...
                    className="flex w-full cursor-text flex-col rounded-3xl border border-light px-3 py-1 duration-150 ease-in-out contain-inline-size motion-safe:transition-[color,background-color,border-color,text-decoration-color,fill,stroke,box-shadow]  dark:shadow-none shadow-[0_9px_9px_0px_rgba(0,0,0,0.01),_0_2px_5px_0px_rgba(0,0,0,0.06)] has-[:focus]:shadow-[0_2px_12px_0px_rgba(0,0,0,0.04),_0_9px_9px_0px_rgba(0,0,0,0.01),_0_2px_5px_0px_rgba(0,0,0,0.06)] bg-token-main-surface-primary dark:bg-messageContainer transition-all"
                  >
                    <Attachments />
                      ...
                      <div className="flex gap-x-1.5 ">
                          ...
                          <div className="relative">
                            <div className="relative">
                              <div className="flex flex-col">
                                <DropdownMenu>
                                  <DropdownMenuTrigger className="flex items-center justify-center h-9 rounded-full border border-light hover:bg-accent w-9 outline-none text-color-secondary">
                                    <svg
                                      width="24"
                                      height="24"
                                      viewBox="0 0 24 24"
                        ...
                        <span data-state="closed">
                          ...
                          >
                            ...
                            <span className="flex text-inherit items-center whitespace-nowrap pl-1 pr-1">
                              Search
                            </span>
                          </label>
                        </span>
