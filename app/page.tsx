...
//       <div
//         className="container relative flex justify-center items-center h-dvh max-w-3xl m-auto p-3 data-[state=true]: origin-top transition-[transform,border-radius] duration-500 ease-[cubic-bezier(0.32,0.72,0,1)]  data-[state=true]:overflow-hidden data-[state=true]:scale-[0.96] data-[state=true]:translate-y-[calc(env(safe-area-inset-top)+14px)]"
//         data-state={isOpen && !isDesktop}
//       >
...
//                           </svg>
//                           <code className="relative rounded ">
//                             + V to Paste
//                           </code>
//                         </div>
